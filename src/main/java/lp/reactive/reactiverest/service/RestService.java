...
public class RestService {
	...
	/**
	 * This method prepares the {@link Call<ResponseBody>} object used to execute the
	 * REST communication
	 *
	 * @param httpRequest,
	 *            a prepared {@link HttpRequest} used for api call
	 ...
	 *            the unique identifier to recognize the response event on event
	 *            bus when it is emitted
	 * @param coordinatorService,
	 *            the coordinator service used to post new event on event bus
	 */
	public static void callEvent(HttpRequest httpRequest, String eventIdentifier,
	 ...
	 *            a prepared {@link HttpRequest} used for api call
	 * @param eventIdentifier,
	 *            the identify used by subscribers to recognize the event on
	 *            event bus
	 * @param coordinatorService,
	 *            the coordinator service used to post new event on event bus
	 */
	...
	public static void callReact(HttpRequest httpRequest,
			...
			io.reactivex.functions.Consumer<Throwable> consumerOnError) {
