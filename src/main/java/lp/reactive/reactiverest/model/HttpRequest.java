...
public class HttpRequest {
    ...
    /**
     * @param baseUrl, the base url used to compose the api call
     */
    private final String baseUrl;

    /**
     * @param apiEndpoint, the relative path used to specify the api endpoint and formulate the complete api call
     */
    private final String apiEndpoint;

    /**
     * @param headers, a set of headers used for api call
     */
    private final Map<String, String> headers;

    /**
     * @param queryParams, the query string used to compose the api call
     */
    private final Map<String, String> queryParams;

    /**
     * @param httpMethod, the http method used to compose the api call
     */
    private final HttpMethod httpMethod;

    /**
     * @param bodyParams, the body parameters used to componse the api call
     */
    private final Map<String, String> bodyParams;

    /**
     * Constructor a new {@link HttpRequest} starting from the given {@param builder}
     */
    ...
    /**
     * Getter method for retrieve the query string
     *
    ...
    public static class Builder {
         ...
         * @param apiEndpoint,
         *         the relative path used to specify the api endpoint and formulate the complete api call
         */
        ...
        /**
         * Build a new {@link HttpRequest} based on constructed and configured {@link Builder}
         *
